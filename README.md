...
Bu proje, yapay zeka araştırmacılarının veya öğrencilerin veri setlerini yükleyip yönetebileceği,
makine öğrenmesi modelleri eğitebileceği ve sonuçları görüntüleyebileceği bir platform oluşturmayı amaçlar.
Sistem hem kullanıcılar hem de yöneticiler için farklı yetkilendirmelere sahip olacak şekilde tasarlanmıştır.
